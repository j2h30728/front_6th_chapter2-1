 ...
 * @returns {number} 수량
 */
export const getQuantityFromCartItem = (cartItem) => {
 ...
 */
export const setQuantityToCartItem = (cartItem, quantity) => {
  const qtyElem = cartItem.querySelector('.quantity-number');
...
import { getPriceHTML, getSaleIcon } from '../product/productUtils.js';
